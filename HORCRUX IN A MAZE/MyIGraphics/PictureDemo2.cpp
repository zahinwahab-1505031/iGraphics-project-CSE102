...
void playscore(int z){
    int scoreinagame[100];
    int i=loadFromFile(scoreinagame);
    scoreinagame[i]=z;
    i++;
    saveToFile(scoreinagame,i);

}
void knowinghighscore(int high){
    ...
    while(!feof(fp1)){
        fscanf(fp1,"%d\n",&highest);
        if(high>highest) maximum=high;
        else maximum=highest;
    }
...
int fetchingtotalscore(void){
    int test;
    fp2=fopen("totalscore.txt","r");
    while(!feof(fp2)){
        fscanf(fp2,"%d\n",&test);
    }
...
void totalscore(int levelscore){
    total+=levelscore;
    fp2=fopen("totalscore.txt","w");

    fprintf(fp2,"%d\n",total);
    fclose(fp2);

    if(q==1)    knowinghighscore(total);


}

int fetchinghighscore(void){
    int highscore;
    fp1=fopen("highscore.txt","r");
    while(!feof(fp1)){
        fscanf(fp1,"%d\n",&highscore);
...
texture locketTexture;
texture cupTexture;
texture diademTexture;
texture naginiTexture;
texture hpTexture;
texture fadedTexture;
texture firstTexture;
texture secondTexture;
texture thirdTexture;
texture fourthTexture;
texture fifthTexture;
texture sixthTexture;
texture lastTexture;

void iTextureInit()
{
    smurfTexture.Create("diary1.bmp");
    harryTexture.Create("welcome2.bmp");
    backTexture.Create("background.bmp");
    level1Texture.Create("level1.bmp");
    ringTexture.Create("ring1.bmp");
    whiteTexture.Create("white.bmp");
    blackTexture.Create("black.bmp");
    locketTexture.Create("locket1.bmp");
    cupTexture.Create("cup.bmp");
    diademTexture.Create("diadem.bmp");
    naginiTexture.Create("nagini.bmp");
    hpTexture.Create("hp.bmp");
    fadedTexture.Create("fadedharry.bmp");
    firstTexture.Create("first.bmp");
    secondTexture.Create("marvolo.bmp");
    thirdTexture.Create("third.bmp");
    fourthTexture.Create("fourth.bmp");
    fifthTexture.Create("fifth.bmp");
    sixthTexture.Create("sixth.bmp");
    lastTexture.Create("last.bmp");
}
...
void iDraw()
{
   int i=0;
    ...
    if(ball_x==270 && ball_y==290 &&flag==1 && f>=0)//270,290
    {
      ...
      if(flag==2){
        drawTexture(0,0,level1Texture);
        iSetColor(255,0,0);
        t=score(f);
        itoa(t,sc,10);
        tsc1=fetchingtotalscore();
        itoa(tsc1,tc1,10);
        tsc2=fetchinghighscore();
        itoa(tsc2,tc2,10);
        iText(200,80,"YOUR TOTAL SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);

        iText(200,280,"HIGH SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,280,tc2,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"CONGRATULATIONS! YOU'VE WON!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,330,"YOU HAVE FOUND ALL HORCRUXES!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc,GLUT_BITMAP_TIMES_ROMAN_24);
    ...
    if (flag1==2){
        ...
        drawTexture(0,0,level1Texture);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND TOM RIDDLE'S DIARY!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'o' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,80,"YOUR TOTAL SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
    ...
    if(flag2==2){
        ...
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc2,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND MARVOLO GAUNT'S RING!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'r' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
 ...
 if (flag3==2){
        ...
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc3,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND SLYTHERIN'S NECKLACE!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'c' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
 ...
 if(flag4==2)
 {
        ...
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc4,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND HUFFLEPUFF'S CUP!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'R' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
...
if(ball_x4!=200 && ball_y4!=300 && flag4==1){
    ...
    if (flag5==2){
        ...
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc5,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND DIADEM OF RAVENCLAW!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'u' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
  ...
  if(ball_x6==130 && ball_y6==230 && flag6==1)
    ...
    if (flag6==2){
        ...
        iText(290,80,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,110,"YOUR SCORE:",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(280,110,sc6,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,300,"YOU HAVE FOUND NAGINI!",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(200,200,"Press 'x' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
...
if(flag2==1&& f12>=0){
     ...
     iSetColor(255, 255,255);
    iFilledRectangle(0,0,400,400);
    drawTexture(0,0,blackTexture);
    drawTexture(0,100,ringTexture);
     drawTexture(260,240,secondTexture);
...
//these are starting and finishing line
    ...
    iText( 105,225 , "START",
       ...
       iSetColor(255,255,255);
       iFilledRectangle(0,0,400,400);
       drawTexture(0,0,backTexture);
       drawTexture(0,00,smurfTexture);
       drawTexture(175,265,firstTexture);
       iSetColor(255, 0, 0);
...
if(flag3==1  && f13>=0){
    ...
    iSetColor(255, 255,255);
    iFilledRectangle(0,0,400,400);
    drawTexture(0,0,whiteTexture);
    drawTexture(0,0,locketTexture);
    drawTexture(175,145,thirdTexture);
    iSetColor(255, 0, 0);
...
if(flag4==1&& f14>=0){
    ...
    iFilledRectangle(0,0,400,400);
    drawTexture(0,0,whiteTexture);
    drawTexture(0,0,cupTexture);
    drawTexture(190,295,fourthTexture);
    iSetColor(255, 0, 0);
 ...
 if(flag5==1&& f15>=0){
    ...
    iClear();
       ...
       iFilledRectangle(0,0,400,400);
       drawTexture(0,0,whiteTexture);
       drawTexture(0,0,diademTexture);
        drawTexture(175,245,fifthTexture);
       iSetColor(255, 0, 0);
    ...
    if(flag6==1 && f16>=0){
       ...
       iFilledRectangle(0,0,400,400);
       drawTexture(0,0,whiteTexture);
       drawTexture(0,0,naginiTexture);
        drawTexture(120,230,sixthTexture);
       iSetColor(255, 0, 0);
    ...
    if(flag==1 && f>=0)//final level
    {
        ...
        iFilledRectangle(0,0,400,400);
        drawTexture(0,0,whiteTexture);
        drawTexture(0,0,hpTexture);
         drawTexture(250,290,lastTexture);
        iSetColor(255, 0, 0);
        iFilledCircle(ball_x,ball_y,4);
        iSetColor(0, 0,0);
        iText(130,370, "WATCH OUT FOR HURDLES!",
          GLUT_BITMAP_TIMES_ROMAN_24);
...

{
    if(key == GLUT_KEY_LEFT)
    {
       ...
       if((((ball_x1-10) <150 )||((ball_x1-10) >150 )||(ball_y1<155)||(ball_y1>255))&&
               ...
               (((ball_x1-10) <250 )||((ball_x1-10) >250 )||(ball_y1<155)||(ball_y1>255))&&
                (((ball_x1-10) <200 )||((ball_x1-10) >200 )||(ball_y1<145)||(ball_y1>155))&&
...
if((((ball_x2-10) <150 )||((ball_x2-10) >150 )||(ball_y2<165)||(ball_y2>225))&&
            (((ball_x2-10) <140 )||((ball_x2-10) >140 )||(ball_y2<225)||(ball_y2>235))&&
...
if((((ball_x3-10) <150 )||((ball_x3-10) >150 )||(ball_y3<165)||(ball_y3>275))&&
            (((ball_x3-10) <170 )||((ball_x3-10) >170 )||(ball_y3<155)||(ball_y3>165))&&//middle
            (((ball_x3-10) <160 )||((ball_x3-10) >160 )||(ball_y3<155)||(ball_y3>165))&&
          ...
          )
        {
         ...
         if((((ball_x4-10) <150 )||((ball_x4-10) >150 )||(ball_y4<175)||(ball_y4>295))&&
            (((ball_x4-10) <140 )||((ball_x4-10) >140 )||(ball_y4<165)||(ball_y4>175))&&
 ...
 if((((ball_y4+10) <170 )||((ball_y4+10) >170 )||(ball_x4<155)||(ball_x4>295))&&
        (((ball_y4+10) <180 )||((ball_y4+10) >180 )||(ball_x4<145)||(ball_x4>155))&&
            ...
            if(   (((ball_y6+10) <130 )||((ball_y6+10) >130 )||(ball_x6<125)||(ball_x6>255))&&
               ...
               (((ball_y6+10) <240 )||((ball_y6+10) >240 )||(ball_x6<125)||(ball_x6>135))&&
                ...
                if((((ball_y2+10) <170 )||((ball_y2+10) >170 )||(ball_x2<155)||(ball_x2>255))&&
                   (((ball_y2+10) <240 )||((ball_y2+10) >240 )||(ball_x2<145)||(ball_x2>155))&&
    ...
    if(key == GLUT_KEY_DOWN)
    {
        ...
        if(
           ...
           (((ball_y1-10) <250 )||((ball_y1-10) >250 )||(ball_x1<205)||(ball_x1>255))&&
            (((ball_y1-10) <140 )||((ball_y1-10) >140 )||(ball_x1<205)||(ball_x1>215))
           &&(flag1==1) )
        {
            ...
            score1(f11);
             ...
             if((((ball_y2-10) <160 )||((ball_y2-10) >160 )||(ball_x2<155)||(ball_x2>255))&&
                (((ball_y2-10) <220 )||((ball_y2-10) >220 )||(ball_x2<145)||(ball_x2>155))&&
      ...
      if((((ball_y3-10) <160 )||((ball_y3-10) >160 )||(ball_x3<155)||(ball_x3>165))&&
         ...
         (((ball_y3-10) <150 )||((ball_y3-10) >150 )||(ball_x3<165)||(ball_x3>175))&&
          ...
          )
        {
         ...
         if((((ball_y4-10) <160 )||((ball_y4-10) >160 )||(ball_x4<155)||(ball_x4>295))&&
             (((ball_y4-10) <160 )||((ball_y4-10) >160 )||(ball_x4<145)||(ball_x4>155))&&
    ...
    if(key == GLUT_KEY_RIGHT)
    {
          ...
          )
        {
            ...
            if((((ball_x1+10) <160 )||((ball_x1+10) >160 )||(ball_y1<155)||(ball_y1>255))&&
               ...
               (((ball_x1+10) <260 )||((ball_x1+10) >260 )||(ball_y1<155)||(ball_y1>255))&&
               (((ball_x1+10) <220 )||((ball_x1+10) >220 )||(ball_y1<145)||(ball_y1>155))&&
               (flag1==1)
        ...
        if((((ball_x3+10) <160 )||((ball_x3+10) >160 )||(ball_y3<165)||(ball_y3>275))&&
            (((ball_x3+10) <180 )||((ball_x3+10) >180 )||(ball_y3<155)||(ball_y3>165))&&//middle
